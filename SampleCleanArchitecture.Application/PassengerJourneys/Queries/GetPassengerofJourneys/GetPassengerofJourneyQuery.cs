...
namespace SampleCleanArchitecture.Application.PassengerJourneys.Queries.GetPassengerofJourneys
{
    ...
    public class GetPassengerOfJourneyQueryHandler(SampleContext sampleContext,IMapper mapper ) : IRequestHandler<GetPassengerofJourneyQuery, List<PassengerJourneyDTO>>
    {
